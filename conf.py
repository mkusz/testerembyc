...
BLOG_AUTHOR = "Maciej Kusz"  # (translatable)
BLOG_TITLE = "testerembyc.pl"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://testerembyc.pl/"
...
LOGO_URL = '/images/testerembyc_logo.svg'
...
FILTERS = {
    ".html": [filters.add_header_permalinks, filters.html_tidy_mini],
    ".jpg": [filters.jpegoptim],
    ".jpeg": [filters.jpegoptim],
    ".png": [filters.optipng],
    ".css": [filters.cssminify],
    ".js": [filters.jsminify],
    ".mlx": [filters.xmlminify]
}
...
<img style="max-height: 15px; max-width: 80px;" src="/images/githubpages_logo.svg" /></a> {license}
"""
...
ROBOTS_EXCLUSIONS = ["/pages/dziekuje-za-zapisanie-do-newslettera/index.html"]
...
<div class="sidebar-module sidebar-module-inset">
  <form method="get" action="https://www.google.com/search" role="search">
    <input type="hidden" name="cx" value="013548426528546093847:kxj9yxvrzlu" />
...
<div class="sidebar-module sidebar-module-inset">
  ...
  w jakiej napisana została aplikacja, którą będziesz testować.
  Całość opisana prostym i zrozumiałym językiem.</p>
  <p style="text-align: center">
    <a class="_submit btn btn-danger" href="/pages/jak-zaczac-automatyzowac-testy/">Pobieram poradnik</a>
  </p>
</div>
...
<div class="sidebar-module sidebar-module-inset">
  ...
  <ol class="list-unstyled icons">
    <li><a target="_bland" class="far fa-envelope" href="mailto:maciej@testerembyc.pl"></a></li>
    <li><a target="_blank" class="fab fa-facebook-f" href="https://www.facebook.com/testerembyc/"></a></li>
    <li><a target="_blank" class="fab fa-instagram" href="https://www.instagram.com/testerembyc/"></a></li>
